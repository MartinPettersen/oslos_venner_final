    ...
    <div>
      {!toggleMenu ? (
        ...
        <>
          ...
          <div className="flex flex-col items-center justify-center p-2 rounded-xl dark:rounded-none gap-1 z-[100] fixed right-[5%] h-30 w-30 bg-green dark:bg-gradient-to-b from-dark-grey to-black">
