      ...
      >
        ...
        <div className="flex items-center justify-center p-4 sm:p-1 w-full">
          <input
            type="submit"
            value="Opprett Forum"
            className="bg-brown dark:dark:bg-gradient-to-r cursor-pointer from-dark-grey to-black text-soft-pink dark:text-pink rounded-full dark:rounded-none w-[80%] dark:w-[90%] dark:sm:w-[54%] dark:h-[30px] drop-shadow-xl hover:drop-shadow-none relative hover:top-[2px] hover:left-[3px]
            "
          />
        </div>
      </form>
